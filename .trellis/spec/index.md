...
`.trellis/spec/` holds the coding guidelines Trellis injects into sessions,
organized by package and layer.
...
reference material for the wire contract; changes there are out of scope —
see `mobile-harmony/index.md` and `AGENTS.md`.
